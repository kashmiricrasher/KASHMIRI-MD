...
async (conn, mek, m, { from, reply }) => {
    const githubRepoURL = 'https://github.com/kashmiricrasher/KASHMIRI-MD';
    ...
    try {
        ...
        await conn.sendMessage(from, {
            image: { url: `https://raw.githubusercontent.com/kashmiricrasher/KASHMIRI-MD/refs/heads/main/lib/kashmiri.jpg` },
