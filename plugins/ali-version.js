...
cmd({
  ...
  try {
    ...
    // Check update status
    let updateMessage = `*✅ ʏᴏᴜʀ ᴋᴀsʜᴍɪʀɪ-ᴍᴅ ʙᴏᴛ ɪs ᴜᴘ-ᴛᴏ-ᴅᴀᴛᴇ!*`;
    if (localVersion !== latestVersion) {
      updateMessage = `*😵‍💫 ʏᴏᴜʀ ᴋᴀsʜᴍɪʀɪ-ᴍᴅ ʙᴏᴛ ɪs ᴏᴜᴛᴅᴀᴛᴇᴅ!*
    ...
    await conn.sendMessage(from, {
      ...
      contextInfo: {
        ...
        forwardedNewsletterMessageInfo: {
          ...
          newsletterName: '☇ 𝐊ɑѕнмι̇яι̇ 𝐌Ɗ 𝐒ʊ̊𝐏𝐏๏፝֟ɼʈ  ⃪🤖͎᪳᪳𝆺𝅥',
          serverMessageId: 143
        }
      }
    }, { quoted: mek });
