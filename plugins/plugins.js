...
const REPO_OWNER = 'kashmiricrashee';
const REPO_NAME = 'KASHMIRI-MD';
...
async (conn, mek, m, { from, reply }) => {
    try {
        ...
        let pluginList = "📂 *KASHMIRI MD PLUGINS:*\n\n";
...
async (conn, mek, m, { from, reply, args, senderNumber }) => {
    try {
        ...
        if (m.quoted && m.quoted.key.fromMe) {
            ...
            if (/📂 \*KASHMIRI MD PLUGINS:\*/i.test(quotedText)) {
        ...
        const statusMessage = {
            image: { url: `https://ibb.co/7xLTpy5Z.jpg` }, // Replace with your image URL
            ...
            contextInfo: {
                ...
                forwardedNewsletterMessageInfo: {
                    ...
                    newsletterName: '𝐊ɑѕнмι̇яι̇ 𝐌Ɗ 𝐒ʊ̊𝐏𝐏๏፝֟ɼʈ 🍁',
                    serverMessageId: 143
                }
            }
        };
