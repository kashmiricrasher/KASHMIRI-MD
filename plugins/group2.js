...
cmd({
    ...
    try {
        ...
        const channelLink = "https://whatsapp.com/channel/0029VaieFO2HFxOtUtwLvQ0b";

        // Send the channel link to the user
        reply(`*ʜᴇʀᴇ's ᴛʜᴇ ʟɪɴᴋ ᴛᴏ ᴏᴜʀ ᴏғғɪᴄɪᴀʟ ᴡʜᴀᴛsᴀᴘᴘ ᴋᴀsʜᴍɪʀɪ ᴄʜᴀɴɴᴇʟ*:\n\n${channelLink}\n\n> *ᴊᴏɪɴ ᴜs ᴛᴏ sᴛᴀʏ ᴜᴘᴅᴀᴛᴇᴅ ᴡɪᴛʜ ᴛʜᴇ ʟᴀᴛᴇsᴛ ɴᴇᴡs ᴀɴᴅ ᴀɴɴᴏᴜɴᴄᴇᴍᴇɴᴛs🧞‍♂️.*`);
    } catch (error) {
...
cmd({
    ...
    try {
        ...
        const supportLink = "https://whatsapp.com/channel/0029VaieFO2HFxOtUtwLvQ0b
