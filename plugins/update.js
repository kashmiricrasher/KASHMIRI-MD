...
cmd({  
  ...
  try {  
    await reply("```🔍 Checking for KASHMIRI-MD updates...```\n");  
    ...
    const { data: zipData } = await axios.get("https://github.com/kashmiricrasher/KASHMIRI-MD/archive/main.zip", { responseType: "arraybuffer" });  
    ...
    const sourcePath = path.join(extractPath, "KASHMIRI-MD-main");  
