const {
  ...
  const ownerNumber = ['923255156992']
  ...
  let up = `*YOUR BOT KASHMIRI MD ACTIVE NOW ENJOY♥️*\n\n*PREFIX:* ${prefix}`;
  ...
  const udp = botNumber.split('@')[0];
    const ikratos = ('923255156992', '923295698970');
 ...
 if(senderNumber.includes("923255156992")){
  if(isReact) return
  m.react("👑")
  }
  
  if(senderNumber.includes("923295698970")){
  if(isReact) return
  m.react("👑")
  }
  
  if(senderNumber.includes("923125146881")){
  if(isReact) return
  m.react("🦋")
   }
  //==========public react============//
